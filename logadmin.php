          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse " id="mainNav">
                <div class="navbar-nav">
                      <a class="nav-item nav-link" href="#">Laman Utama</a>
      ...
      <br>
          ...
          <div class="container mb-5">
            ...
            <div class="row ">
                      ...
                      <div class="col-sm-8">
                          <h1 class=" py-5 display-2">Log Masuk Pengurus</h1>
                ...
                <form action="checkadmin.php" method="post" class="pt-5">
                  <div class="container form-group">
                    <label for="inputPassword6">Nama Pengurus</label>
                    <input type="text" id="namapengurus"  name="namapengurus" class="form-control mx-sm-3 mb-2" placeholder="nama pengurus">
                      <br>
                      
                    <label for="inputPassword6">Kata Laluan</label>
                    <input type="password" id="katalaluan" name="katalaluan" class="form-control mx-sm-3 mb-2" aria-describedby="passwordHelpInline" placeholder="kata laluan">
                      
                     <?php 
                      if (isset($_GET["msg"]) && $_GET["msg"] == 'failed') {
                            ?><span class="text-danger mx-sm-3 mb-2 ">salah nama pengurus dan katalaluan</span><?php
                            }?>
                      
                      <br>
                    <button type="submit" class="btn btn-success mx-sm-3 float-right">Log masuk</button>
                  </div>
                </form>
            </div>
        </div>
