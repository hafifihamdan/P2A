...
if(($kategori == 'pembeli')||($kategori == 'peruncit'))
{
   ...
   mysql_query("INSERT INTO tempahan(gred,kategori,kuantiti,tarikhtempah,jumlah,tarikhisitempah,emel) VALUES ('D','$kategori','$kuantiti','$tarikhtempah','$jumlah','$tarikhisitempah','$emel')");
