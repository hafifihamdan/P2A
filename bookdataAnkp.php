...
if(($kategori == 'pembeli')||($kategori == 'peruncit'))
{
   ...
   mysql_query("INSERT INTO tempahan(gred,kategori,kuantiti,tarikhtempah,jumlah,tarikhisitempah,emel) VALUES ('Anak Pokok','$kategori','$kuantiti','$tarikhtempah','$jumlah','$tarikhisitempah','$emel')");
    Print '<script>alert("Tempahan anda sudah BERJAYA.Sila cetak invoice di laman laporan tempahan");</script>';
    Print '<script>window.location.assign("tempahAp.php");</script>';
