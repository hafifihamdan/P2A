          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse " id="mainNav">
                <div class="navbar-nav">
                      ...
                      <a class="nav-item nav-link active" href="tempahsekarang.php">Tempah Sekarang</a>
                                     ...
                                     <div class="col-sm-4 p-4">
                                      <div class="card" style="width: 18rem;">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <a href="tempahA.php" class="btn btn-success float-right">Tempah</a>
                                              </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="card" style="width: 18rem;">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <a href="tempahB.php" class="btn btn-success float-right">Tempah</a>
                                              </div>
                                        </div>
                                          </div>
                                       ...
                                       <div class="card" style="width: 18rem;">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <a href="tempahC.php" class="btn btn-success float-right">Tempah</a>
                                              </div>
                                        </div>
                                      </div>
                          </div>
                                     ...
                                     <div class="col-sm-4 p-4">
                                      <div class="card" style="width: 18rem;">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <a href="tempahD.php" class="btn btn-success float-right">Tempah</a>
                                              </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="card" style="width: 18rem;">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <a href="tempahAnk.php" class="btn btn-success float-right">Tempah</a>
                                              </div>
                                        </div>
                                          </div>
