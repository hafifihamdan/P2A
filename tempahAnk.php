                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <nav aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="tempahsekarang.php">Menu</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Tempah</li>
                              </ol>
                        </nav>
                    </div>
                    <div class="col-sm-6 pt-4">
                        <img src="image/produk/anakpokok.jpg" style="width: 30rem;">
                    
                    </div>
                 
                <div class="col-sm-6 pt-4">
                    
                 <form action="bookdataAnk.php" method="post">
                     
                       <h5 class="card-title">Anak Pokok</h5>
                     <p class="card-text">Harga : RM 0.50</p>
